...
public interface ClockInStrategy<T extends ClockInBaseRequest> {

    boolean supports(StoreEntity store, String method);
    ...
    default void validate(StoreEntity store, ClockInBaseRequest request) { // // 타입이 맞는지 검사하고, 안전하게 validateInternal()을 호출
