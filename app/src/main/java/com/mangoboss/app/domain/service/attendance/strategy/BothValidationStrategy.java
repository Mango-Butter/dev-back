...
import com.mangoboss.app.dto.attendance.base.BothRequest;
...
public class BothValidationStrategy implements AttendanceValidationStrategy<BothRequest> {
    ...
    @Override
    public Class<BothRequest> getRequestType() {
        return BothRequest.class;
    }

    @Override
    public void validateInternal(StoreEntity store, BothRequest request) {
        validateGps(store, request);
        validateQr(store, request);
    }

    private void validateGps(StoreEntity store, BothRequest request) {
    ...
    private void validateQr(StoreEntity store, BothRequest request) {
